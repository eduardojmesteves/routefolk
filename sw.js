...
const CACHE = 'routefolk-shell-v81-stage-map-fixes-01';
...
const SHELL_ASSETS = [
  ...
  './styles/v2-integration.css?v=20260516-v2-fix-stage-map-01',
  ...
  './screens/v2/v2-archive-map.js?v=20260516-v2-svg-map-01',
