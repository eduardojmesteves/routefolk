// ============================================================
// routefolk — screens/v2/v2-app.js
// Designer v2 renderer mapped to existing STATE/data.
// Render-only module: runtime is app-v2.js, actions are v2-actions.js.
// ============================================================
...
export function renderRoutefolkV2() {
...
window.__routefolkV2Render = renderRoutefolkV2;
document.addEventListener('routefolk:v2-render', renderRoutefolkV2);
window.addEventListener('resize', renderRoutefolkV2);
renderRoutefolkV2();
