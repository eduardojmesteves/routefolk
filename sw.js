...
const CACHE = 'routefolk-shell-v110-wizard-weather-04';
...
const SHELL_ASSETS = [
  ...
  './styles/wizards.css?v=20260519-wizard-weather-04',
  ...
  './screens/app-actions.js?v=20260519-wizard-weather-04',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
