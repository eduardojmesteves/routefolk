...
// Stage domain: add stage, select/open stage, edit, save, remove and reorder.
// ============================================================
...
export async function removeStage(event, stageId) {
  ...
  if (!window.confirm(`Remove stage “${stage.start_location || 'Start'} to ${stage.end_location || 'End'}”?`)) return;
